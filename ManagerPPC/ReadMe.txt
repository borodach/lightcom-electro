================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : ManagerPPC Project Overview
===============================================================================

The application wizard has created this ManagerPPC application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your ManagerPPC application.
...
ManagerPPC.h
    ...
    project specific headers and declares the CManagerPPCApp application class.

ManagerPPC.cpp
    This is the main application source file that contains the application
    class CManagerPPCApp.
...
ManagerPPCDoc.h, ManagerPPCDoc.cpp - the document
    These files contain your CManagerPPCDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CManagerPPCDoc::Serialize).

ManagerPPCView.h, ManagerPPCView.cpp - the view of the document
    These files contain your CManagerPPCView class.
    CManagerPPCView objects are used to view CManagerPPCDoc objects.
...
StdAfx.h, StdAfx.cpp
    ...
    named ManagerPPC.pch and a precompiled types file named StdAfx.obj.
