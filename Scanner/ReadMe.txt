================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : PPCMercury Project Overview
===============================================================================

The application wizard has created this PPCMercury application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PPCMercury application.
...
PPCMercury.h
    ...
    project specific headers and declares the CPPCMercuryApp application class.

PPCMercury.cpp
    This is the main application source file that contains the application
    class CPPCMercuryApp.
...
PPCMercuryDlg.h, PPCMercuryDlg.cpp - the dialog
    These files contain your CPPCMercuryDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named PPCMercury.pch and a precompiled types file named StdAfx.obj.
