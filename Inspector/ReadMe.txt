================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Inspector Project Overview
===============================================================================

The application wizard has created this Inspector application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Inspector application.
...
Inspector.h
    ...
    project specific headers and declares the CInspectorApp application class.
...
InspectorDlg.h, InspectorDlg.cpp - the dialog
    These files contain your CInspectorDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named Inspector.pch and a precompiled types file named StdAfx.obj.
